...
where a.office_id=46 and b.id!=101 and b.classification_enum=5
...
and a.type_enum=1 
and a.entry_date between '2017-01-01' and '2017-05-31' 
where a.office_id=46  and b.id!=101 and b.classification_enum=4
group by b.name, glcode, type 
...
where a.office_id=${officeId} and b.id!=101 and b.classification_enum=5
group by b.name, glcode, type 
order by glcode) debits 
...
and a.type_enum=1 
and a.entry_date between '${startDate}' and '${endDate}'
where a.office_id=${officeId}  and b.id!=101 and b.classification_enum=4
group by b.name, glcode, type 
order by glcode) credits 

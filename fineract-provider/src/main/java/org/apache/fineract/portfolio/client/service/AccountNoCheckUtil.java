...
public class AccountNoCheckUtil {
	 ...
	 * @return
	 */
	public static String fetchaccountNoOwner(String accountNo, RoutingDataSource dataSource)   {
		
		String displayName="";
		int clientId=0;
		
		String sql;
		   sql = "SELECT display_name, id FROM m_client where account_no='" + accountNo + "'";
		  Statement stmt = null;

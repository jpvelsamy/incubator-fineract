...
public class ClientReadPlatformServiceImpl implements ClientReadPlatformService {
    ...
    public ClientData retrieveTemplate(final Long officeId, final boolean staffInSelectedOfficeOnly) {
        ...
        return ClientData.template(defaultOfficeId, new LocalDate(), offices, staffOptions, null, genderOptions, savingsProductDatas,
                ...
                clientLegalFormOptions,address,isAddressEnabled, datatableTemplates, 0, 0, null, null, null, null, defaultOfficeId);
    }
    ...
    private static final class ClientMembersOfGroupMapper implements RowMapper<ClientData> {
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final String activeProducts = rs.getString("activeProducts"); 

            final long activeLoans = rs.getLong("activeLoans");
            
            final String closedProducts = rs.getString("closedProducts");
    ...
    private static final class ClientMapper implements RowMapper<ClientData> {
        ...
        public ClientMapper() {
            ...
            builder.append("act.total_balance as totalBalance, act.loan_products as activeProducts , act.total_loans as activeLoans, clo.loan_products as closedProducts, clo.total_loans as closedLoans, clo.loan_status_string as closedStatus ");
            ...
            builder.append("inner join CLIENT_ACTIVE_LOAN_STATUS act on c.id=act.id ");
            builder.append("inner join CLIENT_CLOSED_LOAN_STATUS clo on c.id=clo.id ");
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            final ClientTimelineData timeline = new ClientTimelineData(submittedOnDate, submittedByUsername, submittedByFirstname,
                    submittedByLastname, activationDate, activatedByUsername, activatedByFirstname, activatedByLastname, closedOnDate,
                    closedByUsername, closedByFirstname, closedByLastname, totalBalance, activeProducts, activeLoans, closedProducts, closedStatus, closedLoans);
    ...
    private static final class ClientIdentifierMapper implements RowMapper<ClientData> {
        ...
        public ClientData mapRow(final ResultSet rs, @SuppressWarnings("unused") final int rowNum) throws SQLException {
            ...
            return ClientData.clientIdentifier(id, accountNo, firstname, middlename, lastname, fullname, displayName, officeId, officeName, 0, 0, null, null, null, null, 0);
        }
    }
    ...
    public ClientData retrieveAllNarrations(final String clientNarrations) {
        ...
        return ClientData.template(null, null, null, null, narrations, null, null, clientTypeOptions, clientClassificationOptions, 
        		clientNonPersonConstitutionOptions, clientNonPersonMainBusinessLineOptions, clientLegalFormOptions,null,null, null, 0, 0, null, clientNarrations, clientNarrations, clientNarrations, 0);
    }

...
public class DataCheckUtil {
	 ...
	 * @return
	 */
	public static String fetchExternalIdOwner(String externalId, RoutingDataSource dataSource)   {
		
		String displayName="";
		int clientId=0;
		
		String sql;
		   sql = "SELECT display_name, id FROM m_client where external_id='" + externalId + "'";
		  Statement stmt = null;
